...
func NewParser(opts ...gopapageno.ParserOpt) *gopapageno.Parser {
	...
	fn := func(rule uint16, lhs *gopapageno.Token, rhs []*gopapageno.Token, thread int) {
		...
		case 1:
			...
			{
				*E_F_S_T1.Value.(*int64) = *E_F_S_T1.Value.(*int64) + *E_F_S_T3.Value.(*int64)
				E_S0.Value = E_F_S_T1.Value
			}
		case 2:
			E_S0 := lhs
			E_F_S_T1 := rhs[0]
			...
			{
				*E_F_S_T1.Value.(*int64) = *E_F_S_T1.Value.(*int64) + *E_S_T3.Value.(*int64)
				E_S0.Value = E_F_S_T1.Value
			}
		case 3:
			E_S_T0 := lhs
		...
		case 5:
			...
			{
				*E_S1.Value.(*int64) = *E_S1.Value.(*int64) + *E_F_S_T3.Value.(*int64)
				E_S0.Value = E_S1.Value
			}
		case 6:
			E_S0 := lhs
			E_S1 := rhs[0]
			...
			{
				*E_S1.Value.(*int64) = *E_S1.Value.(*int64) + *E_S_T3.Value.(*int64)
				E_S0.Value = E_S1.Value
			}
		case 7:
			NEW_AXIOM0 := lhs
		...
		case 8:
			...
			{
				*E_S_T1.Value.(*int64) = *E_S_T1.Value.(*int64) + *E_F_S_T3.Value.(*int64)
				E_S0.Value = E_S_T1.Value
			}
		case 9:
			E_S0 := lhs
			E_S_T1 := rhs[0]
			...
			{
				*E_S_T1.Value.(*int64) = *E_S_T1.Value.(*int64) + *E_S_T3.Value.(*int64)
				E_S0.Value = E_S_T1.Value
			}
		case 10:
			E_S_T0 := lhs
