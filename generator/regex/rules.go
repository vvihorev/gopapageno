...
var _RULES = []rule{
	...
	rule{RE_SIMPLE_RE, []uint16{anyc}},
	rule{CONCATENATION_RE_SIMPLE_RE, []uint16{anyc, CONCATENATION_RE_SIMPLE_RE}},
	rule{CONCATENATION_RE_SIMPLE_RE, []uint16{anyc, RE_SIMPLE_RE}},
	rule{RE_SIMPLE_RE, []uint16{anyc, plus}},
	rule{CONCATENATION_RE_SIMPLE_RE, []uint16{anyc, plus, CONCATENATION_RE_SIMPLE_RE}},
	rule{CONCATENATION_RE_SIMPLE_RE, []uint16{anyc, plus, RE_SIMPLE_RE}},
	rule{RE_SIMPLE_RE, []uint16{anyc, star}},
	rule{CONCATENATION_RE_SIMPLE_RE, []uint16{anyc, star, CONCATENATION_RE_SIMPLE_RE}},
	rule{CONCATENATION_RE_SIMPLE_RE, []uint16{anyc, star, RE_SIMPLE_RE}},
